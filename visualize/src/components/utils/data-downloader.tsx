...
export const colors = {
  raoul: { rgb: 'rgb(67 56 202)', border: 'border-indigo-700', textClass: 'text-indigo-700', bgClass: 'bg-indigo-700' },
  thomas: { rgb: 'rgb(21 128 61)', border: 'border-green-700', textClass: 'text-green-700', bgClass: 'bg-green-700' },
  yorick: { rgb: 'rgb(14 116 144)', border: 'border-cyan-700', textClass: 'text-cyan-700', bgClass: 'bg-cyan-700' },
